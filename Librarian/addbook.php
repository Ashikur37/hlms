              ...
              <form role="form" method="POST" action="addbook_core.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <label for="exampleInputdetna">Edition</label>
                    <input name="edition" id="exampleInputdetna" type="text" class="form-control"  placeholder="Edition">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputdetn">Shelf</label>
                    <input name="shelf" id="exampleInputdetn" type="text" class="form-control" placeholder="Shelf">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputdet">Quantity</label>
                      <input name="quantity" id="exampleInputdet" type="text" class="form-control" placeholder="Quantity">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputde">Page</label>
                      <input name="page" id="exampleInputde" type="text" class="form-control" placeholder="Page">
                  </div>
                   <div class="form-group">
