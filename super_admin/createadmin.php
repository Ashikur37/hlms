              ...
              <form role="form" method="POST" action="createadmin_core.php">
                <div class="card-body">
                  ...
                  <label for="exampleInputdetname">Title</label>
                    <input type="text" id="exampleInputdetname" name="name" class="form-control" placeholder="Enter Title ">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputdetnamee">Password</label>
                    <input name="password" id="exampleInputdetnamee" type="password" class="form-control"  placeholder="Enter Password">
                  </div>
                  <div class="form-group">
