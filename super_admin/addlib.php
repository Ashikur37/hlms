              ...
              <form role="form" method="POST" action="addlib_core.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <label for="exampleInputdetname">User Name</label>
                    <input type="text" id="exampleInputdetname" name="name" class="form-control" placeholder="Enter User Name">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputdetnamee">Email</label>
                    <input name="email" id="exampleInputdetnamee" type="email" class="form-control"  placeholder="Enter Email">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputdetna">Password</label>
                    <input name="password" id="exampleInputdetna" type="password" class="form-control"  placeholder="Enter Password">
                  </div>
                   <div class="form-group">
